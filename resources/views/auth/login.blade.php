                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">مرحباً بك في Royal Done! 👋</h4>
                                <p class="card-text mb-2">الرجاء تسجيل الدخول لحسابك لتبدء المغامرة!</p>
                                   ...
                                   @csrf
                                    ...
                                    <div class="mb-1">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="remember-me"> تـذكـرنـي </label>
                                        </div>
                                    </div>
                                ...
                                <p class="text-center mt-2">
                                    <span>ليس لديك حساب على منصتنا؟!</span>
